...
public class FBlocks{
    ...
    public static void load(){
        ...
        scab = new ItemTurret("scab"){{
            ...
            ammo(
                FItems.flesh, new FleshBulletType(15.6f, 75.0f, 12, 6, 120.0f){{
                    lifetime = 125.0f;
                    drag = 0.05f;
                    homingDelay = 10.0f;
                    homingPower = 0.06f;
                    ...
                    trailEffect = FStatusEffects.overgrown.effect;
                    trailChance = 0.15f;
            ...
            jackpotAmmo.add(
                ...
                new JackpotAmmo(Items.copper, 0.45f,
                    ...
                    new BasicBulletType(18.0f, 180.0f){{
                        ...
                        shootEffect = FFx.squareEffect(60.0f, 4, 3.0f, 45.0f, null);
                        frontColor = Color.white;
                ...
                new JackpotAmmo(Items.thorium, 0.3f,
                    ...
                    new BasicBulletType(10.5f, 160.0f){{
                        ...
                        chargeEffect = chargeFx;
                        shootEffect = FFx.squareEffect(60.0f, 2, 3.0f, 45.0f, null);
                ...
                new JackpotAmmo(Items.surgeAlloy, 0.15f,
                    ...
                    new BasicBulletType(10.5f, 90.0f){{
                        ...
                        chargeEffect = chargeFx;
                        shootEffect = FFx.squareEffect(25.0f, 1, 3.0f, 45.0f, null);
                ...
                new JackpotAmmo(FItems.hardenedAlloy, 0.0f,
                    ...
                    new BasicBulletType(10.5f, 75.0f){{
                        ...
                        chargeEffect = chargeFx;
                        shootEffect = FFx.squareEffect(15.0f, 1, 3.0f, 45.0f, null);
        ...
        distance = new ItemTurret("ql"){{
            ...
            ammo(
                ...
                FItems.logicAlloy, new SpriteBulletType(3.0f, 300.0f, 18.0f, 30.0f, "fire-missile"){{
                    lifetime = 167.0f;
                ...
                FItems.detonationCompound, new SpriteBulletType(4.0f, 210.0f, 18.0f, 30.0f, "fire-missile"){{
                    lifetime = 193.0f;
                    splashDamage = 330.0f;
        ...
        magneticDomain = new EnergyField.EnergyFieldPowerTurret("magnetic-domain"){{
            ...
            shootType = new EnergyField.EnergyFieldBulletType(30.0f, 10){{
                ...
                hitEffect = FFx.chainLightningThin;
        ...
        grudge = new ItemTurret("grudge"){{
            ...
            ammo(
                ...
                FItems.detonationCompound, new BasicBulletType(8.0f, 65.0f){{
                    lifetime = 46.0f;
                    knockback = 0.7f;
                    width = 18.0f;
                    height = 25.0f;
                ...
                FItems.hardenedAlloy, new BasicBulletType(9.0f, 220.0f){{
                    lifetime = 72f;
                    knockback = 2.0f;
                    width = 28f;
                    height = 32f;
        ...
        aerolite = new ItemTurret("aerolite"){{
            ...
            ammo(
                ...
                FItems.detonationCompound, new ArtilleryBulletType(8.0f,0.0f){{
                    Color
        ...
        cryofluidMixerLarge = new GenericCrafter("cryofluid-mixer-large"){{
            ...
            updateEffect = FFx.squareEffect(30.0f, 6, 2.4f, 0.0f, Liquids.cryofluid.color.cpy().mul(1.05f));
            drawer = new DrawMulti(
                new DrawRegion("-bottom"),
                new DrawLiquidTile(Liquids.water),
        ...
        hardenedAlloyCrucible = new EnergyCrafter("hardened-alloy-crucible"){{
            ...
            craftEffect = new MultiEffect(
                FFx.crossEffect(45.0f, 4.0f, 0.0f, true, null),
                Fx.mineImpact,
                FFx.drillSteamFast,
                FFx.mineImpactWaveZ
            );
        ...
        fleshReconstructor = new UnitFactory("flesh-reconstructor"){
            ...
            }
            {
                ...
                plans.add(
                    new UnitFactory.UnitPlan(FUnitTypes.blade, 2700.0f, with(
                        FItems.flesh, 55,
        ...
        envStormyCoast2 = new EnvBlock("env-stormy-coast2"){{
            buildType = () -> new EnvBlockBuild(){
                ...
                protected void updateStart(){
                    ...
                    if(!Groups.weather.contains(w -> w.weather == FWeathers.rainstorm)){
                        if(!Groups.weather.isEmpty()) Groups.weather.clear();
