    ...
    public static void load(){
        ...
        grudge = new ItemTurret("grudge"){{
            ...
            ammo(
                ...
                FRItems.hardenedAlloy, new BasicBulletType(9.0f, 235.0f){{
                    lifetime = 72.0f;
                    knockback = 2.0f;
                    width = 28.0f;
                    height = 32.0f;
            ...
            shootType = new BulletType(15.5f, 1800.0f){
                ...
                }
                {
                    ...
                    fragBullet = new BasicBulletType(12.0f, 225.0f){{
                        ...
                        trailWidth = 4;
                        trailColor = _92f3fd;
                        hitEffect = despawnEffect = FRFx.hitBulletSmall(_92f3fd);
                    }};
                }
            };
        }};
        ...
        focusingExtractor = new BeamExtractor("focusing-extractor", 5){{
            ...
            barrels.add(new BeamExtractor.Barrel(
                "-pri", 0.0f, 3.0f, 4.0f, 1.1f, 1.1f
            ));
            for(var p : Geometry.d8edge)
                barrels.add(new BeamExtractor.Barrel("-sec", p.x * 9.0f, p.y * 9.0f, 1.2f, 0.7f, 0.7f));
